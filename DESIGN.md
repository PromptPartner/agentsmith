...
- **Layout:** a navy hero with a working terminal example; light sections for the process, proof, support, and quick start. Maximum content width 1120 px. Single column below 700 px.

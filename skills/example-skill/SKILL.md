---
name: example-skill
description: Template/example skill showing the minimal structure. Replace or delete it. Use as a starting point when you want to capture a repeatable workflow as a skill.
compatibility: Designed for coding agents that implement the Agent Skills specification.
---
